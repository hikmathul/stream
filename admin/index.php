<?php 
  ...
  $jumlah_laporan = mysqli_fetch_assoc(mysqli_query($koneksi, "SELECT count(id_laporan) as jumlah_laporan FROM tb_laporan"));
  $jumlah_laporan = $jumlah_laporan['jumlah_laporan'];
?>
<!DOCTYPE html>
<html>
<head>
      ...
      <div class="container-fluid">
        <div class="row my-2">
          ...
          <div class="col-lg-3">
            <div class="card">
              <div class="card-body">
                <h5><i class="fas fa-fw fa-comment"></i> Laporan</h5>
                <h6 class="mb-2 text-muted">Jumlah laporan: <?= $jumlah_laporan; ?></h6>
                <a href="laporan.php" class="card-link btn btn-primary"><i class="fas fa-fw fa-align-justify"></i></a>
              </div>
            </div>
          </div>
        </div>
